...
public class ontroller extends BaseController {
    private AttachFileService attachFileService;
	public ontroller(AttachFileService attachFileService){
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<ResponseDto<Long>> delete(@PathVariable Long id) throws ServerException, InsufficientDataException, ErrorResponseException, IOException, NoSuchAlgorithmException, InvalidKeyException, InvalidResponseException, XmlParserException, InternalException {
	...
	public ResponseEntity<ResponseDto<List<Long>>> delete(@RequestParam List<Long> ids) throws ServerException, InsufficientDataException, ErrorResponseException, IOException, NoSuchAlgorithmException, InvalidKeyException, InvalidResponseException, XmlParserException, InternalException {
		attachFileService.delete(ids);
